 ...
 * and the seeded-picklists invariant so a lab created via either path lands
 * with the same default vocabulary set.
 */
...
/**
 * Create a new lab row + seed its picklists / primer sets / pcr protocols.
 * Returns the new lab's id. Throws if the slug collides with an existing
 * lab — caller should surface a 409.
 */
