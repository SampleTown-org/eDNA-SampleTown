...
<div class="space-y-6">
	...
	>
		{#snippet filterActions()}
			...
			{/if}
			<a href="/pcr/new" class="hidden sm:inline-flex write-only px-3 py-1.5 bg-ocean-600 text-white rounded-lg hover:bg-ocean-500 transition-colors text-sm font-medium">New PCR</a>
		{/snippet}
	</DataTable>
