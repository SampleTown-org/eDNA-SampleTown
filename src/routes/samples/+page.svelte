...
<div class="space-y-4">
	...
	>
		{#snippet filterActions()}
			...
			<a href="/samples/wizard" class="inline-flex write-only px-3 py-1.5 bg-ocean-600 text-white rounded-lg hover:bg-ocean-500 transition-colors text-sm font-medium">Quick Capture</a>
		{/snippet}
	</DataTable>
</div>
