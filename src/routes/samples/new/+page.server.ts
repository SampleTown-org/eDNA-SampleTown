...
export const load: PageServerLoad = async ({ url }) => {
	...
	`).all();
	const picklists = getConstrainedValues('geo_loc_name', 'env_broad_scale', 'env_local_scale', 'env_medium', 'filter_type', 'preservation_method', 'storage_conditions', 'person_role');
